...
## Sheets cannot be deleted via API

**`tableau-apply-workbook` can only ADD or UPDATE sheets. It cannot delete them.**
...
**Recovery paths:** Tableau Undo (`Cmd+Z`), File → Revert to Saved, or manually editing the saved `.twb` XML file.
