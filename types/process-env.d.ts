export interface ProcessEnvEx {
  ...
  SESSION_STORAGE_CONFIG: string | undefined;
  ...
  OAUTH_AUTHORIZATION_CODE_STORAGE_CONFIG: string | undefined;
  OAUTH_ACCESS_TOKEN_TIMEOUT_MS: string | undefined;
  OAUTH_REFRESH_TOKEN_STORAGE_CONFIG: string | undefined;
  OAUTH_PENDING_AUTHORIZATION_STORAGE_CONFIG: string | undefined;
}
