...
const envVars = {
  ...
  SESSION_STORAGE_CONFIG: {
    ...
    description: 'The session storage config.',
    required: false,
    sensitive: false,
  },
  ...
  OAUTH_AUTHORIZATION_CODE_STORAGE_CONFIG: {
    includeInUserConfig: false,
    type: 'string',
    title: 'OAuth Authorization Code Storage Config',
    description: 'The OAuth authorization code storage config.',
    required: false,
    sensitive: false,
  },
  OAUTH_REFRESH_TOKEN_STORAGE_CONFIG: {
    includeInUserConfig: false,
    type: 'string',
    title: 'OAuth Refresh Token Storage Config',
    description: 'The OAuth refresh token storage config.',
    required: false,
    sensitive: false,
  },
  OAUTH_PENDING_AUTHORIZATION_STORAGE_CONFIG: {
    includeInUserConfig: false,
    type: 'string',
    title: 'OAuth Pending Authorization Storage Config',
    description: 'The OAuth pending authorization storage config.',
    required: false,
    sensitive: false,
  },
} satisfies EnvVars;
