...
const envVars = {
  ...
  FLOW_TOOLS_ENABLED: {
    ...
    description:
      'Registers the read-only Tableau Prep flow tools (list-flows, get-flow, list-flow-runs, list-flow-tasks, get-flow-task). This is also the base gate required by FLOW_WRITE_TOOLS_ENABLED. Disabled by default; set to "true" and enable the "flow-tools" feature flag to enable the flow tool family.',
    required: false,
    sensitive: false,
  },
  INSIGHTS_TOOLS_ENABLED: {
    ...
    description:
      'Registers the datasource-context insight tools (generate-insight-cards). Disabled by default; set to "true" to enable them.',
    required: false,
    sensitive: false,
  },
  FLOW_WRITE_TOOLS_ENABLED: {
    ...
    description:
      'Requires FLOW_WRITE_TOOLS_ENABLED=true, FLOW_TOOLS_ENABLED=true, and the flow-tools feature flag. Enables run-flow, run-flow-task, and cancel-flow-run. Defaults to "false".',
    required: false,
    sensitive: false,
  },
