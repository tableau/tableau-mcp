...
const envVars = {
  ...
  FLOW_TOOLS_ENABLED: {
    ...
    description:
      'Registers the Tableau Prep flow tools (list-flows, get-flow, list-flow-runs, list-flow-tasks). Disabled by default; set to "true" and enable the "flow-tools" feature flag to enable them.',
    required: false,
    sensitive: false,
  },
