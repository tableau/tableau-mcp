...
export const getServiceAuthInfoFromCache = (
  requestId: RequestId,
): TableauServiceAuthInfo | undefined => serviceAuthInfoCache.get(requestId);

export const setServiceAuthInfoInCache = (
  requestId: RequestId,
  info: TableauServiceAuthInfo,
): void => {
