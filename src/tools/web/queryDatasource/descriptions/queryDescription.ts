...
When Tableau Knowledge evidence defines a requested value, query only fields explicitly bound by that evidence and confirmed queryable by datasource metadata. Do not substitute or offer similarly named or proxy fields for missing bindings; instead, report the missing bindings and ask for authoritative field mappings or another datasource.
