...
describe('scaffoldDataAppTool', () => {
  ...
  it('persists a provided requestedOrigins (trimmed) into the workspace dataapp.json', async () => {
    const extra = getMockRequestHandlerExtra();
    const data = getData(
      await getToolResult({ ...base, requestedOrigins: '  https://api.example.com  ' }, extra),
    );
  ...
  it('omits requestedOrigins from the workspace dataapp.json when the arg is absent', async () => {
    const extra = getMockRequestHandlerExtra();
