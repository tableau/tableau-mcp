...
- To target an explicit period or an arbitrary date range, set \`measurement_period.range\` to \`'RANGE_BY_CONFIG'\` and provide \`measurement_period.specific_period\`. This is the ONLY way to analyze a custom span (e.g. April 15-20); \`specific_period\` is IGNORED unless range is \`'RANGE_BY_CONFIG'\`.
