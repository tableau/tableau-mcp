...
const NON_TOOL_VOCABULARY = [
  ...
  'ambiguous-field',
  // Calc-authoring External Client API command names (namespace tabdoc) driven by author-calc,
  // not MCP tool names — same class as create-calc and set-active-datasource below.
  'apply-calculation',
