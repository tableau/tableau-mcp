...
// Binder proposal contract for bind-template (Call-2 validate): the zod shape for a
// filled BindingProposal lives in ONE place. A divergence between copies is exactly the
// fail-open the watch-class audit guards against — a
