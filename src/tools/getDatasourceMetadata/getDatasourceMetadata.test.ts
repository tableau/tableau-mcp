...
describe('getDatasourceMetadataTool', () => {
  ...
  it('should handle null publishedDatasources in listFields response', async () => {
    mocks.mockReadMetadata.mockResolvedValue(mockReadMetadataResponses.success);
    mocks.mockGraphql.mockResolvedValue(mockListFieldsResponses.noDatasources);
  ...
  it('should handle null fields in listFields response', async () => {
    mocks.mockReadMetadata.mockResolvedValue(mockReadMetadataResponses.success);
    mocks.mockGraphql.mockResolvedValue(mockListFieldsResponses.noFields);
