 ...
 * Sixty-three tools cover the full Workout-Wednesday-W44 dialect plus on-demand expertise,
 * first-class workbook/data reads/navigation, scoped datasource/dashboard/story cached-XML
 * fallbacks, and a narrow whole-workbook cached-XML fallback. Standalone validation and unrelated
 * info/site tools stay out. This is the
