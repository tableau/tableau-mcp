 ...
 * producer OpenAPI contract (OpenAPI 3.1, `info.version` 0.2.14), composed from
 * the 0.2.13 production registry/generator contract and the live-captured Workbook
 * Optimizer contract. The dialog contract was canonical-JSON compared on 2026-09-08.
