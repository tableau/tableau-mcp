 ...
 * 0.2.13 capture was available. The worksheet `/showMe` path, its response components, and
 * `info.version` 0.2.14 were projected on 2026-09-12 from the W-23715530 monolith producer branch
 * `dev/michaelyu/w-23715530-get-show-me-options` because no live 0.2.14 Desktop capture was
 * available. The dialog contract was generated from the monolith production registry and
 * canonical-JSON compared on 2026-09-08. The rest remains the live 0.2.9 capture.
 */
...
describe('external client API contract (captured openapi fixture)', () => {
  ...
  describe('routes', () => {
    ...
    it('preserves the projected worksheet refresh-now Operation contract at 0.2.14', () => {
      expect(spec.info.version).toBe('0.2.14');
