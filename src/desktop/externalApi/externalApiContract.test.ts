 ...
 * with the datasource route metadata generated by the merged monolith change 35b8bba24c94. It grows `AppInfo`
 ...
 * required `index`/`type`/`StoryboardItem.storyPointCount`, `unsupported-target-version`), then
 * adds the individual datasource metadata and document GET/POST contracts.
 */
...
describe('external client API contract (captured openapi fixture)', () => {
  ...
  describe('data-first read schemas', () => {
    ...
    it('pins the complete 0.2.10 requiredness exception set', () => {
