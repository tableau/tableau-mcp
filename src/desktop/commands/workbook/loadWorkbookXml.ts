...
export async function loadWorkbookXml({
  ...
  // The External Client API ("Athena V0") whole-workbook POST replaces the open workbook with the
  // posted document. The apply lock serializes it against the per-sheet paths' fetch-modify-apply.
