...
// command until a human dismisses it. commandNameRegistry.ts already refuses an
...
import type { CommandValidationResult } from './commandNameRegistry.js';
import {
  checkCommandPolicy,
  dialogPolicyFor,
...
import { type CommandReferenceEntry, loadCommandsReference } from './commandsReference.js';
