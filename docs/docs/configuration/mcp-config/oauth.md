...
| [empty]     | false             | **User already has an active Tableau session in their browser:** <br/>User can choose their site.<br /><br /> **User does not already have an active Tableau session in their browser:** <br/>User will be signed into the Default site.<br /><br />_Ideally the user could choose their site, but this is the behavior as of 2025.3. If this is problematic, the workaround is to have the user preemptively sign to a site on the Server in their browser and then connect to the MCP server. If this workaround is insufficient, please open a GitHub issue._ | **User already has an active Tableau session in their browser:** <br/>User can choose their site from the site picker.<br /><br /> **User does not already have an active Tableau session in their browser:** <br/>User will be asked to enter their site name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| MySite      | false             | **User already has an active Tableau session in their browser:** <br/>User can choose their site.<br /><br />**User does not already have an active Tableau session in their browser:** <br/>User will be signed into MySite.<br /><br /> _Ideally the user could choose their site, but this is the behavior as of 2025.3. If this is problematic, the workaround is to have the user preemptively sign to a site on the Server in their browser and then connect to the MCP server. If this workaround is insufficient, please open a GitHub issue._           | **User already has an active Tableau session in their browser:** <br/>User can choose their site.<br /><br /> _Unfortunately, this also means the user could select a site that exists on a pod other than the one specified on the `SERVER` environment variable. If they do this, the OAuth flow will stop prematurely and the user will need to reconnect their MCP client._<br /><br /> **User does not already have an active Tableau session in their browser:** <br/>User will be signed into MySite.<br /><br /> _Ideally the user could choose their site, but this is the behavior as of 2025.3. If this is problematic, the workaround is to have the user preemptively sign to a site on the Server in their browser and then connect to the MCP server. If this workaround is insufficient, please open a GitHub issue._ |
