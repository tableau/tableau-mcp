...
| [list-metric-definitions-from-definition-ids](tools/pulse/list-metric-definitions-from-definition-ids.md) | List Pulse Metric Definitions from Metric Definition IDs ([Pulse API][pulse])                         |
