...
| [get-view-data](tools/views/get-view-data.md)                                                                         | Retrieves data in CSV format for the specified view in a Tableau workbook. _Note: the get-view-data api currently has a limitation that when used on a dashboard sheet type, it will only return data for the first worksheet in the dashboard. This will be fixed in the 26.3 fall release._ ([REST API][get-view-data]) | All SKUs        |
...
| [get-custom-view-data](tools/views/get-custom-view-data.md)                                                           | Retrieves data in CSV format for the specified custom view in a Tableau workbook. _Note: the same limitation of get-view-data exists for this tool._ ([REST API][get-custom-view-data])                                                                                                                                   | All SKUs        |
...
| [delete-content](tools/content/delete-content.md)                                                                     | Admin-only. Two-phase (preview/confirm) delete of a workbook, data source, or extract refresh task ([REST API][delete-workbook], [REST API][delete-datasource], [REST API][delete-extract-refresh-task])                                                                                                                  | All SKUs        |
| [get-knowledge-suggestions](tools/knowledge/get-knowledge-suggestions.md)                                             | Returns graph health and improvement suggestions for an explicit Tableau Knowledge graph                                                                                                                                                                                                                                  | Tableau Cloud\* |
| [list-knowledge-sources](tools/knowledge/list-knowledge-sources.md)                                                   | Lists published data sources and workbooks in an explicit Tableau Knowledge graph                                                                                                                                                                                                                                         | Tableau Cloud\* |
| [search-knowledge-nodes](tools/knowledge/search-knowledge-nodes.md)                                                   | Semantically searches nodes in an explicit Tableau Knowledge graph                                                                                                                                                                                                                                                        | Tableau Cloud\* |
| [get-knowledge-node](tools/knowledge/get-knowledge-node.md)                                                           | Resolves one detailed knowledge node or returns disambiguation candidates                                                                                                                                                                                                                                                 | Tableau Cloud\* |
| [get-knowledge-node-relationships](tools/knowledge/get-knowledge-node-relationships.md)                               | Returns filtered relationships around one knowledge node                                                                                                                                                                                                                                                                  | Tableau Cloud\* |
| [get-knowledge-lineage](tools/knowledge/get-knowledge-lineage.md)                                                     | Returns dependency lineage for one knowledge node                                                                                                                                                                                                                                                                         | Tableau Cloud\* |
| [get-knowledge-node-impact](tools/knowledge/get-knowledge-node-impact.md)                                             | Returns assets transitively affected by one knowledge node                                                                                                                                                                                                                                                                | Tableau Cloud\* |
| [create-knowledge-semantic-statements](tools/knowledge/create-knowledge-semantic-statements.md)                       | Creates attached or graph-wide semantic statements in an explicit Tableau Knowledge graph                                                                                                                                                                                                                                 | Tableau Cloud\* |
| [list-knowledge-semantic-statements](tools/knowledge/list-knowledge-semantic-statements.md)                           | Lists graph statements or the attached-plus-global statements that apply to one node                                                                                                                                                                                                                                      | Tableau Cloud\* |
| [update-knowledge-semantic-statements](tools/knowledge/update-knowledge-semantic-statements.md)                       | Replaces semantic statements, metadata, or their graph attachment                                                                                                                                                                                                                                                         | Tableau Cloud\* |
...
\* The knowledge tools require Tableau Knowledge to be available for the site.
